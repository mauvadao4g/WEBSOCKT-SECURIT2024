...
if [[ "$resposta" = '1' ]]; then
    ...
    wget -P $_Ink https://raw.githubusercontent.com/mauvadao4g/WEBSOCKT-SECURIT2024/main/I/list >/dev/null 2>&1
    verif_key
    sleep 3s
    echo "/bin/menu" >/bin/h && chmod +x /bin/h >/dev/null 2>&1
    rm versao* >/dev/null 2>&1
    wget  https://raw.githubusercontent.com/mauvadao4g/WEBSOCKT-SECURIT2024/main/versao >/dev/null 2>&1
    rm v2raymanager >/dev/null 2>&1
    wget wget https://raw.githubusercontent.com/mauvadao4g/WEBSOCKT-SECURIT2024/main/M/v2raymanager >/dev/null 2>&1
    wget wget https://raw.githubusercontent.com/mauvadao4g/WEBSOCKT-SECURIT2024/main/M/botteste.sh >/dev/null 2>&1
    chmod 777 v2raymanager >/dev/null 2>&1
    chmod 777 botteste.sh >/dev/null 2>&1
    mkdir $HOME/BOT >/dev/null 2>&1
    cd $HOME/BOT
    wget wget https://raw.githubusercontent.com/mauvadao4g/WEBSOCKT-SECURIT2024/main/I/ShellBot.sh >/dev/null 2>&1
    chmod 777 ShellBot.sh >/dev/null 2>&1
    cd >/dev/null 2>&1
    chmod 777 licence >/dev/null 2>&1
    mkdir /etc/rec >/dev/null 2>&1
    cd /etc/rec
    wget https://raw.githubusercontent.com/mauvadao4g/WEBSOCKT-SECURIT2024/main/I/licence >/dev/null 2>&1
    chmod 777 licence >/dev/null 2>&1
    cd >/dev/null 2>&1
    #-----------------------------------------------------------------------------------------------------------------
    ...
    echo 'figlet -k MAUDAVPN | lolcat' >>/root/.bashrc
    ...
    echo -e "\033[01;31m║\033[1;33m MAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@mauvadao\033[0m"
    ...
    wget https://raw.githubusercontent.com/mauvadao4g/WEBSOCKT-SECURIT2024/main/versao >/dev/null 2>&1
    rm v2raymanager >/dev/null 2>&1
    wget https://raw.githubusercontent.com/mauvadao4g/WEBSOCKT-SECURIT2024/main/M/v2raymanager >/dev/null 2>&1
    wget  https://raw.githubusercontent.com/mauvadao4g/WEBSOCKT-SECURIT2024/main/M/botteste.sh >/dev/null 2>&1
    chmod 777 v2raymanager >/dev/null 2>&1
    chmod 777 botteste.sh >/dev/null 2>&1
    mkdir $HOME/BOT >/dev/null 2>&1
    cd $HOME/BOT
    wget https://raw.githubusercontent.com/mauvadao4g/WEBSOCKT-SECURIT2024/main/I/ShellBot.sh >/dev/null 2>&1
    chmod 777 ShellBot.sh >/dev/null 2>&1
    cd >/dev/null 2>&1
    chmod 777 licence >/dev/null 2>&1
    mkdir /etc/rec >/dev/null 2>&1
